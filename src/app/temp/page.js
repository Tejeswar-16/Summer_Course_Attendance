      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col gap-6 animate-fade-in">
        ...
        {students.length > 0 && !loading && (
          <div className="glass-panel rounded-2xl p-6 flex flex-col gap-5 border border-zinc-200/80 animate-fade-in delay-100">
            ...
            {/* Table (with horizontal scroll for smaller viewports) */}
            <div className="overflow-x-auto border border-zinc-200 rounded-xl bg-white/40">
                  ...
                  {filteredStudents.length === 0 ? (
                    ...
                    filteredStudents.map((student) => {
                      ...
                      return (
                        <tr 
                          key={student.id} 
                          className="hover:bg-gray-200/50 transition duration-150"
                        >
                          <td className="p-4">
                          ...
                          <td className="p-4 text-right">
                            <button
                              ...
                              className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-indigo-500 hover:bg-indigo-650 text-white font-extrabold text-xs border border-indigo-450 transition-all active:scale-95 cursor-pointer disabled:opacity-50 shadow-sm"
                            >
                              {isRowDownloading ? (
